					...
					<table border="1" cellspacing="0" class="board_view">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									<textarea name="sSummary" id="sSummary" cols="100" rows="10" class="size100p"></textarea>
								</td>
							</tr>																				
							<tr>
								<th><label for="sLinkUrl">링크</label></th>
								<td colspan="3">
									<input type="text" name="sLinkUrl" id="sLinkUrl" maxlength="200" title="링크" class="size500">
