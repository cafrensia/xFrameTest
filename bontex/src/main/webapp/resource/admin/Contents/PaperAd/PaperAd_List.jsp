				...
				<div class="section">
					<table brder="1" cellspacing="0" class="board_list_type1">
						...
						<tbody>						
							<tr>
								...
								<td>동원</td>
								<td class="l15"><a href="/resource/admin/Contents/PaperAd/PaperAd_Edit.jsp" class="link">동원참치(아이편)</a></td>
								<td>2015.09.10</td>
					...
					<div class="board_pager_wrap">					
						...
						<div class="board_btn right">
							<a href="/resource/admin/Contents/PaperAd/PaperAd_Write.jsp" class="btn mid black"><span>등록</span></a>
