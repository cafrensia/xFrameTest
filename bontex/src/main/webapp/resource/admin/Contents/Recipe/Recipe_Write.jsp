					...
					<table border="1" cellspacing="0" class="board_view">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="5">
									<input type="text" name="sTitle" id="sTitle" maxlength="100" title="레시피명 입력" class="size500">
								</td>
							</tr>							
							<tr>
								<th><label for="sSummary">요약정보</label></th>
								<td colspan="5">
									<input type="text" name="sSummary" id="sSummary" maxlength="100" title="요약정보 입력" class="size500">
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input type="radio" name="sClass" id="sClass2" value="1" title="중" class="mar_l15"> <label for="sClass2">중</label>
								...
								<td colspan="3">
									<input type="text" name="sCookTime1" id="sCookTime1" maxlength="3" title="조리시작시간입력" class="size115"> 분
									~
									<input type="text" name="sCookTime2" id="sCookTime2" maxlength="3" title="조리종료시간입력" class="size115"> 분
								</td>
							</tr>	
							<tr>
								<th><label for="sMaterial ">재료</label></th>
								<td colspan="5">
									<input type="text" name="sMaterial" id="sMaterial" maxlength="100" title="재료 입력" class="size500">
								</td>
							</tr>
							<tr>
