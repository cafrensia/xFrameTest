...
<div id="LP_CFSelList" class="lp_wrap lp_CFSelList">
	<!-- LP Header -->
	<div class="lp_header">
		<h2>홍보CF 선택</h2>
	</div>
				...
				<table border="1" cellspacing="0" class="board_list_type1 board_list_scroll">
					...
					<tbody>
						<tr>
							...
							<td width="110"><img src="/Images/Common/img_noVideo.gif" alt="NO Video"></td>
							<td width="90">동원</td>
							<td width="200" class="l15">동원참치(아이편)</td>
