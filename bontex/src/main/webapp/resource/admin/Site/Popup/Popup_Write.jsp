					...
					<table border="1" cellspacing="0" class="board_view">
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" name="sTitle" id="sTitle" maxlength="100" title="팝업명입력" class="size500">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									X : <input type="text" name="sPosX" id="sPosX" maxlength="4" title="팝업 X좌표입력" class="size115 mar_r20">
									Y : <input type="text" name="sPosY" id="sPosY" maxlength="4" title="팝업 Y좌표입력" class="size115">
							...
							<tr>
								...
								<td>
									W : <input type="text" name="sSizeW" id="sSizeW" maxlength="4" title="팝업 폭입력" class="size115 mar_r20">
									H : <input type="text" name="sSizeY" id="sSizeY" maxlength="4" title="팝업 높이입력" class="size115">
							...
							<tr>
								...
								<td>
									<span class="input_date"><input type="text" name="sStartDate" id="sStartDate" maxlength="10" title="게시 시작일자 입력" readonly class="size115 datepicker"><button type="button" onClick="javascript:openCal('sStartDate');" class="btn_datepicker"><span>시작날짜선택</span></button></span>
									~
									<span class="input_date"><input type="text" name="sEndDate" id="sEndDate" maxlength="10" title="게시 종료일자 입력" readonly class="size115 datepicker"><button type="button" onClick="javascript:openCal('sEndDate');" class="btn_datepicker"><span>종료날짜선택</span></button></span>
								</td>
							</tr>
							<tr>	
