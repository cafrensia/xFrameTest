			...
			<div class="contents_body">
				...
				<div class="section">
					<table border="1" cellspacing="0" class="board_view">
						...
						<tbody>
							<tr>
								<th><label for="sAuthType" class="ast">권한선택</label></th>
								<td>
									<select name="sAuthType" id="sAuthType" title="권한선택" class="size115">
							...
							<tr>
								<th><label for="sStatus" class="ast">상태</label></th>
								<td>
							...
							<tr>
								...
								<td>
									<input type="text" name="sID" id="sID" maxlength="20" title="관리자ID입력" class="size115">
							...
							<tr>
								...
								<td>
									<input type="text" name="sName" id="sName" maxlength="20" title="이름입력" class="size115">
								</td>
							</tr>														
							<tr>	
							...
							<tr>
								...
								<td colspan="3">		
									<input type="text" name="sTel1" id="sTel1" maxlength="4" title="전화번호 첫째자리 입력" class="size115">
									-
									<input type="text" name="sTel2" id="sTel2" maxlength="4" title="전화번호 둘째자리 입력" class="size115">
									-
									<input type="text" name="sTel3" id="sTel3" maxlength="4" title="전화번호 세째자리 입력" class="size115">
								</td>	
							</tr>
							<tr>
								<th><label for="sEmail" class="ast">이메일</label></th>
								<td>
									<input type="text" name="sEmail" id="sEmail" maxlength="50" title="이메일입력" class="size115"> @ dongwon.com
								</td>
							</tr>							
						</tbody>	
					</table>
