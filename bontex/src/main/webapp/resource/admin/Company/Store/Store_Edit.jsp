					...
					<table border="1" cellspacing="0" class="board_view">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" name="sBranch" id="sBranch" maxlength="30" value="서부지점" title="지점명 입력" class="size115">
								</td>
							</tr>
							<tr>
								<th><label for="sAddr">주소</label></th>
								<td colspan="3">
									<input type="text" name="sAddr" id="sAddr" maxlength="200" value="서울특별시 은평구 연서로 165 (갈현동) 4층" title="주소 입력" class="size500">
								</td>
							</tr>							
							<tr>
								<th><label for="sMapUrl">지도 URL</label></th>
								<td colspan="3">
									<input type="text" name="sMapUrl" id="sMapUrl" maxlength="200" value="http://www.google.com" title="지도Url 입력" class="size500">
							...
							<tr>
								...
								<td>
									<input type="text" name="sTel" id="sTel" maxlength="15" value="02-1234-5689" title="전화번호 입력" class="size115">
								</td>
								<th><label for="sFax">팩스번호</label></th>
								<td>
									<input type="text" name="sFax" id="sFax" maxlength="15" value="02-1234-5678" title="팩스번호 입력" class="size115">								
								</td>
							</tr>
							<tr>
