					...
					<table border="1" cellspacing="0" class="board_view">
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" name="sBrand" id="sBrand" maxlength="20" title="작성자입력" class="size500">
								</td>
							</tr>
							<tr>
							...
							<tr>	
								...
								<td>
									...
									<button type="button" onClick="javascript:selUpFile('sThumbnail');" title="썸네일이미지 선택" class="btn sml gray "><span>파일선택</span></button>
							...
							<tr>	
								...
								<td>
									...
									<button type="button" onClick="javascript:selUpFile('sUpFile');" title="첨부파일선택" class="btn sml gray "><span>파일선택</span></button>
									<span class="mar_l10"><span class="blue">*</span> 이미지 권장 사이즈 : 150 x 70</span>								
								</td>
							</tr>															
							<tr>
							...
							<tr>
								...
								<td>		
									<textarea name="sContent" id="sContent" rows="10" cols="130" class="size100p"></textarea>
