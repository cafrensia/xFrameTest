					...
					<table border="1" cellspacing="0" class="board_view">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" name="sTitle" id="sTitle" maxlength="100" value="뉴스게시판 글 제목입니다." title="글 제목입력" class="size500">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<span class="input_date"><input type="text" name="sRegDate" id="sRegDate" maxlength="10" value="2015-09-10" title="등록일자 입력" readonly class="size115 datepicker"><button type="button" onClick="javascript:openCal('sRegDate');" class="btn_datepicker"><span>등록일자선택</span></button></span>
								</td>
							...
							<tr>
								...
								<td colspan="3">		
									<textarea name="sContent" id="sContent" rows="15" cols="130" class="size100p">뉴스게시판 내용글입니다. </textarea>
								</td>	
							</tr>
						</tbody>	
					</table>
